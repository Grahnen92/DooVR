...
Plane::Plane(glm::vec3 _pos, float _mass, glm::vec2 _dim)
{
	...
	glBufferData(GL_ARRAY_BUFFER,
		6 * nverts * sizeof(GLfloat), vertexarray, GL_STREAM_DRAW);
...
void Plane::updateVertexArray() {
	...
	//6 * nverts
	//3 * ntris
	vertexarray[6 * 4 + 0] = 0.0f;
	vertexarray[6 * 4 + 1] = 0.5f;
	vertexarray[6 * 4 + 2] = 0.0f;
	vertexarray[6 * 4 + 3] = 0.0f;
	vertexarray[6 * 4 + 4] = 1.0f;
	vertexarray[6 * 4 + 5] = 0.0f;
